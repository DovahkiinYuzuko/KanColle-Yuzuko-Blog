 ...
 */
export async function generateFleetImage(deckBuilder, theme, customConfigPath) {
    ...
    `;
        ...
        const isCustomUrls = config.urls.start2Url !== 'https://raw.githubusercontent.com/Nishisonic/gkcoi/master/static/START2.json' ||
        ...
        try {
            await page.waitForFunction(() => window.renderResult !== null, { timeout: 15000 });
            dataUrlResult = await page.evaluate(() => window.renderResult);
        }
        catch (err) {
